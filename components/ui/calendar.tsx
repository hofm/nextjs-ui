...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        months:
          'flex flex-col sm:flex-row space-y-4 sm:space-x-14 sm:space-y-0',
        month: 'space-y-4',
        caption: 'flex justify-center pt-1 relative items-center',
        caption_label: 'text-lg font-normal uppercase',
        ...
        head_row: 'flex',
        head_cell:
          'text-muted-foreground rounded-md w-14 font-medium uppercase text-[0.8rem]',
